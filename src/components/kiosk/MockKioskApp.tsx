...
import { MockAppointmentMenuScreen } from "./MockAppointmentMenuScreen";
...
export function MockKioskApp() {
  ...
  return (
    <KioskFrame>
      ...
      {step === "no-appointment" && <SalesScreen submitting={false} onBack={goMenu} onConfirm={resetHome} />}
